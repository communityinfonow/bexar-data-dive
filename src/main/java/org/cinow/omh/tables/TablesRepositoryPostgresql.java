...
public class TablesRepositoryPostgresql implements TablesRepository{
	...
	public void populateTablesData(TablesDataRequest request, TablesData data) {
		String sql = ""
			...
			+	" 	 iv.year_, round(iv.indicator_value, 1) as indicator_value, round(iv.moe_low, 1) as moe_low, round(iv.moe_high, 1) as moe_high, round(iv.universe_value, 1) as universe_value, round(iv.count_value, 1) as count_value, iv.suppress, "
