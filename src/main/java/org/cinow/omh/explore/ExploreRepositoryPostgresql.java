...
public class ExploreRepositoryPostgresql implements ExploreRepository {
	...
	public List<PointCollection> getPoints() {
		String sql = ""
			...
			+ "   p.id_ as p_id, p.year_ as p_year, p.value_ as p_value, p.feature_properties_en as p_feature_properties_en, p.feature_properties_es as p_feature_properties_es, p.geojson as p_geojson "
