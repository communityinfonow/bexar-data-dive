...
public class CommunityRepositoryPostgresql implements CommunityRepository {
	...
	public List<CommunityDataCategory> getCommunityData(String location, String locationType, String filterType) {
		String sql = ""
			...
			+ "   i.id_ as indicator_id, i.name_en as indicator_name_en, i.name_es as indicator_name_es, i.rate_per, i.description_en as indicator_description_en, i.description_es as indicator_description_es, i.is_aggregable, "
