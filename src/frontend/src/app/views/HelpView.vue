<template>
  <v-container fluid class="pa-0">
    <section id="page-header" class="page-header d-flex flex-column light--text px-12 pb-4">
      ...
      <div v-if="$t('help_view.headline')" class="font-weight-medium mt-2" style="font-size: 1.25rem;" v-html="$t('help_view.headline')"></div>
    </section>
