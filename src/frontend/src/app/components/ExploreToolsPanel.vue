	...
	<v-col cols="auto" :style="{ 'max-height': panelMaxHeight }">
		<v-form v-if="filters" ref="compareForm" v-model="valid">
			<v-row class="mt-2 justify-end">
				<v-col cols="6" sm="12" v-if="showMapControls" class="d-flex">
					<v-select
				...
				<v-col cols="2" sm="12" v-if="showCompareOptions">
					<v-select
				...
				<v-col cols="4" sm="12" v-if="showCompareOptions">
					<v-autocomplete
				...
				<v-col cols="4" sm="12" v-if="!showHighlightFilteredLocation">
					<div class="d-flex justify-end" :class="$vuetify.breakpoint.smAndDown ? 'flex-column' : 'flex-row'">
				...
				<v-col v-if="showHighlightFilteredLocation" cols="6" sm="12" class="d-flex justify-end" :class="$vuetify.breakpoint.smAndDown ? 'flex-column' : 'flex-row'">
